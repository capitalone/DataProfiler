...
class TestBaseModel(unittest.TestCase):
    ...
    def test_register_subclass(self, mock_subclasses):
        ...
        self.assertIn(
            mock.call().__setitem__("fakemodel", fake_class), mock_subclasses.mock_calls
        )

    @mock.patch(
        "dataprofiler.labelers.base_model.BaseModel." "__abstractmethods__", set()
    )
    @mock.patch(
        "dataprofiler.labelers.base_model.BaseModel." "_validate_parameters",
        return_value=None,
    )
    def test_equality_checks(self, *mocks):
        ...
        fake_model1 = FakeModel1(label_mapping={"a": 1, "b": 2}, parameters={"test": 1})
        fake_model1_1 = FakeModel1(
            label_mapping={"a": 1, "b": 2}, parameters={"test": 1}
        )
        fake_model1_2 = FakeModel1(label_mapping={"c": 2}, parameters={"test": 1})
        fake_model1_3 = FakeModel1(
            label_mapping={"a": 1, "b": 2}, parameters={"Different": 1}
        )
        fake_model2 = FakeModel2(
            label_mapping={"a": 1, "b": 2}, parameters={"a": 1, "b": 2}
        )
    ...
    def test_get_parameters(self):
        ...
        self.assertDictEqual(
            {"label_mapping": {"a": 1, "c": "2"}, "test1": 1, "test2": "2"}, params
        )
    ...
    def test_set_label_mapping_parameters(self):
        ...
        with self.assertRaisesRegex(
            ...
            base_model.BaseModel.set_label_mapping(mock_model, label_mapping=1)
