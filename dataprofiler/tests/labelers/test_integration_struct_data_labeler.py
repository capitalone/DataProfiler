...
class TestStructuredDataLabeler(unittest.TestCase):
    ...
    def test_warning_tf(self):
        ...
        profile = dp.StructuredProfiler(data, profiler_options=profile_options)
    ...
    def test_warning_tf_run_dp_merge(self):
        ...
        print('running dp1')
        profile1 = dp.StructuredProfiler(data, profiler_options=profile_options)
        ...
        print('running dp2')
        profile2 = dp.StructuredProfiler(data, profiler_options=profile_options)
