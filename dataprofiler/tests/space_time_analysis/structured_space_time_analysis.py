...
def dp_profile_space_analysis(
    ...
    :param data_: DataFrame that is to be profiled
    :type data_: pandas.DataFrame
    ...
    with memray.Tracker(path):
        profile = dp.Profiler(data_, options=options, samples_per_update=len(data_))
...
if __name__ == "__main__":
    ...
    if not DATASET_PATH:
        full_dataset = generate_dataset_by_class(
            rng,
